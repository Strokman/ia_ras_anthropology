...
Revision ID: 6905570c2371
Revises: 
Create Date: 2023-07-06 14:09:51.228490
...
def upgrade():
    ...
    with op.batch_alter_table('database_users', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_database_users_email'), ['email'], unique=True)
        batch_op.create_index(batch_op.f('ix_database_users_username'), ['username'], unique=True)
    ...
    sa.ForeignKeyConstraint(['grave_id'], ['graves.id'], ),
...
def downgrade():
    ...
    with op.batch_alter_table('database_users', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_database_users_email'))
