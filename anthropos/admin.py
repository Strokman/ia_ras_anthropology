...
admin.add_view(ModelView(FederalDistrict, db.session, category='Locations'))
admin.add_view(ModelView(Region, db.session, category='Locations'))
admin.add_view(ModelView(Epoch, db.session, category='Fixed tables'))
admin.add_view(ModelView(Preservation, db.session, category='Fixed tables'))
admin.add_view(ModelView(Sex, db.session, category='Fixed tables'))
